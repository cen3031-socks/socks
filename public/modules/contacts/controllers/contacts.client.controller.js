...
contactsApp.controller('ContactsViewController', [ '$scope', 'Contacts', '$stateParams', '$modal', 'Authentication', '$location', 'Dialogs', '$log',
    function ($scope, Contacts, $stateParams, $modal, Authentication, $location, Dialogs, $log) {
