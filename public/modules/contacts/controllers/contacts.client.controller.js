...
contactsApp.controller('ContactsController', [
	'$scope', '$stateParams', 'Authentication', 'Contacts', '$modal', '$log', '$location', 'Dialogs',
...
contactsApp.controller('ContactsCreateController', [
	'$scope', 'Contacts', '$location',
...
contactsApp.controller('ContactsUpdateController', [
	'$scope', 'Contacts', '$stateParams', '$modal', 'Dialogs',
	function ($scope, Contacts, $stateParams, $modal, Dialogs) {

	}
]);

contactsApp.controller('ContactsViewController', [
	'$scope', 'Contacts', '$stateParams', '$modal', 'Authentication', '$location', 'Volunteers', 'Dialogs', '$log',
...
contactsApp.directive('contactList', [
	function() {
		return {
			restrict: 'E',
			transclude: true,
